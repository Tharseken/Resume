...
\address{ 
  \faGlobe{ 
    \href{https://tharseken.github.io}{tharseken}
  } {   |    }
  \Letter{ 
...
\begin{rSection}{Projects}
  \begin{rWorkSection}{Social Networking Web Application}
                     {\href{https://github.com/tharseken/Social-Networking-Web-Application}{\ExternalLink}}
                     {Language(s): JavaScript, HTML, CSS | Stack: MongoDB, Express, React, Node.js}
                     {}
  ...
  \begin{rWorkSection}{Mobile Messaging App}
                      {\href{https://github.com/tharseken/Mobile-Messaging-Application}{\ExternalLink}}
                      {Language(s): Swift}
                      {}
    \item Developed an instant messaging application based on a MVC design structure
  ...
  \begin{rWorkSection}{Stock Predictor \& Analyzer}
                      {\href{https://github.com/tharseken/Stock-Predictor-and-Analyzer}{\ExternalLink}}
                      {Languages: Python}
                      {}
    \item Developed a basic stock data scraper and classifier to identify when to buy, sell, or hold a particular stock based on previous stock prices
