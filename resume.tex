...
\address{
	...
	\href{mailto:tharseken.n@gmail.com}{\faEnvelope\ tharseken.n@gmail.com} \\
...
\begin{document}
	...
	\begin{rSection}{Experience}
		...
		\begin{rWorkSection}
			...
			{}
			{
				% \item Developed Lambda APIs to allow employee headcount modification for Amazon fulfillment centre voluntary shift opportunities allowing for more accurate labor plan estimation
